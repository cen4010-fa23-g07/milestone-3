...
// includes
// windows.h required for windows app
#include <windows.h>
// defines TCHAR macro whe unicode is not enabled
#include <tchar.h>
// required for using the new operator
#include <new>
...
void DRAW_Forgot(HDC hdc, _In_ HWND   hWnd)
{
	...
	HWND recoverWnd = FindWindowExW(hWnd, emailWnd, NULL, NULL);
